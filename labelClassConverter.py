...
def labelClassConverter(converter_yaml: str, data_yaml: str) -> None:
    ...
    for dataset in tqdm(const_yaml["datasets"], "Converting dataset classes..."):
        ...
        for txt in labels:
            ...
            for line in f:
                ...
                if line_list[0] in classes.keys():
                    new_line = line.replace(line_list[0], classes[line_list[0]], 1) + "\n"
...
if __name__ == "__main__":
    ...
    labelClassConverter(converter_yaml, data_yaml)
